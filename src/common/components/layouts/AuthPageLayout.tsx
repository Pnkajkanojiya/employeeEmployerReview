...
const AuthPageLayout: React.FC<AuthPageLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="bg-gray-900 flex items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-6xl overflow-hidden bg-white h-auto md:h-[685px] rounded-lg shadow-lg relative">
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-1/2 p-12 relative flex items-center justify-center">
