...
const Login: React.FC = () => {
  ...
  return (
    <div className=" bg-gray-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-4xl overflow-hidden bg-white h-[700px] rounded-lg shadow-lg">
        <div className="flex flex-col md:flex-row">
          <div className="relative w-full md:w-1/2 p-8 flex flex-col justify-center items-center text-white">
            <div className="absolute inset-0">
              <svg
                ...
                viewBox="0 0 750 861"
                fill="none"
                style={{ top: '0%', left: '0%', width: '95%', height: '108%' }}
              >
                <circle
                  cx="612"
                  cy="612"
              ...
              <div className="absolute top-98 right-24 w-37 h-37 rounded-full bg-gradient-to-r from-[#007BF8] to-[#012770] transform scale-x-[-1]"></div>
            </div>
          ...
          <div className="w-[90%] md:w-1/2  ">
            ...
            >
              <h2 className="text-2xl font-bold  text-black">Registration !</h2>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-[90%] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 mb-[12px]"
                      required
                    />{' '}
                    <br />
                    <button
                ...
                <div className="mb-2">
                  <label className="inline-flex items-center">
                    ...
                    />
                    <p className="ml-2 text-sm text-gray-700" style={{ fontSize: '14px' }}>
                      By Signing Up, You’re agree to our
                      <span className="text-[#007DFC]">Terms & Conditions</span> and <br />
